...
namespace InventaryApp.Server.Migrations
{
    ...
    [Migration("20201207045628_BussinessAndAccount")]
    partial class BussinessAndAccount
    {
            ...
            modelBuilder.Entity("InventaryApp.Server.Entities.Account", b =>
                {
                    ...
                    b.Property<string>("BussinnessId")
                        .HasColumnType("nvarchar(450)");
